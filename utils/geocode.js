...
const geocode = (address, callback) => {
    const url = 'https://api.mapbox.com/geocoding/v5/mapbox.places/' + encodeURIComponent(address) + '.json?access_token=pk.eyJ1IjoiZnJhbmtwb29sZSIsImEiOiJja3FicHBlN2cwY292MnVvZXdmc3l1d243In0.4v-hLWQGX2ScbuaFJbPrUQ&limit=1'
